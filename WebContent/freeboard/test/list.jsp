			...
			<div class="inner">
				<div class="c_util_servicelink">
					...
					<ul>
						...
						<li>
							<a href="${root }/user/userList" class="">마이페이지</a>
						</li>
		...
		<div class="col-7 align-left ml-0 my-lg-2">
			...
			<form action="${root }/qa/list" id="searchForm" class="form-inline my-0">			
	      		<select name="type" id="inlineFormCustomSelectPref">      
					<option value="T" ${pageMaker.cri.type eq 'T' ? 'selected' : ''}>Q&A</option>
					<option value="C" ${pageMaker.cri.type eq 'C' ? 'selected' : ''}>배송</option>
					<option value="S" ${pageMaker.cri.type eq 'S' ? 'selected' : ''}>환불</option>
					<option value="W" ${pageMaker.cri.type eq 'W' ? 'selected' : ''}>기타</option>
